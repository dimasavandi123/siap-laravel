 ...
 <main class="flex-shrink-0">
     ...
     <section class="bg-body-tertiary" style="background-color: #9BB8CD!important;">
         <div class="container p-5">
             <div class="row row-cols-3 row-cols-sm-6 row-cols-md-8 g-3 d-flex justify-content-center">
                 <div class="col">
                     <a href="" class="nourl">
                         <div class="card shadow-sm books-link">
                             <img src="https://via.placeholder.com/400x400?text=Kategori" class="img-fluid">
                             <div class="card-body">
     ...
     <div class="container pt-0 pb-5">
         <div class="py-2">
             <div
                 ...
                 <h1 class="h2">Buku Terbaru</h1>
                 <div class="btn-toolbar mb-2 mb-md-0">
                     <div class="btn-group me-2">
                         <a href="/books" class="btn btn-sm btn-outline-secondary">Lihat Semua</a>
                     </div>
                 </div>
             </div>
